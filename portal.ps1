...
Write-Host "=================================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "📦 Building all tenants (wcah, oms-v0, oms-v1, oms-v2)..." -ForegroundColor Yellow
npx pagenary build --all

Write-Host ""
Write-Host "🌐 Updating root portal hub at dist/index.html..." -ForegroundColor Yellow
