...
| :--- | :--- | :--- |
| **2026-08-21** | [Repository Report](#repo-status-2026-08-21) | ⛔ Production API still has **zero auth** on world-open 443; VPS pinned at `8025da4` (two PRs behind `main` `0c7b6a8`). ✅ `main` green — PRs #15–#19 including Week Board #18 and this morning's ADR/`CONTEXT.md` docs PR #19. ⚠ Three verified doc contradictions remain. |
| **2026-08-20 (2nd pass)** | [Repository Report](#repo-status-2026-08-20-2) | ⛔ Production is still **unauthenticated** on 443 and now **two merges behind** `main` (`8025da4` vs `dfdc48b`) — redeploy blocked on a GitHub deploy key. ✅ PR #18 ships **Week Board #4b** end-to-end (23rd table, board API, interactive screen); CI green **both sides** of the merge — first clean merge since #12. ⚠ Docs drift worsened: `developer.md` still says the board is not yet built. |
