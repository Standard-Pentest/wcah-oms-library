...
This repository houses the complete documentation ecosystem for the WCAH OMS platform across its architectural evolution. Powered by the [Pagenary](https://github.com/jmagly/pagenary) multi-tenant documentation generator, it unifies **179 documentation pages** across four distinct tenant portals with search, navigation, and [West Coast Animal Hospital](https://www.westcoast.vet/) branding.
...
| Command | Description |
| :--- | :--- |
| `npm run build` | Builds all 4 tenants and generates the root portal hub at `dist/index.html`. |
...
├── scripts/
│   └── build-portal.js        # Root portal hub builder (dist/index.html)
├── tenants/
